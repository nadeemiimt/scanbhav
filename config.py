...
FINNHUB_API_KEY = setting("FINNHUB_API_KEY", "") or setting("SCAN_BHAV_FINNHUB_API_KEY", "")
FINNHUB_WEBHOOK_SECRET = setting("FINNHUB_WEBHOOK_SECRET", "") or setting("SCAN_BHAV_FINNHUB_WEBHOOK_SECRET", "")
FINNHUB_WEBHOOK_PUBLIC_URL = setting("FINNHUB_WEBHOOK_PUBLIC_URL", "")

STOCKTWITS_USERNAME = setting("STOCKTWITS_USERNAME", "") or setting("SCAN_BHAV_STOCKTWITS_USERNAME", "")
STOCKTWITS_PASSWORD = setting("STOCKTWITS_PASSWORD", "") or setting("SCAN_BHAV_STOCKTWITS_PASSWORD", "")
